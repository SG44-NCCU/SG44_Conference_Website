      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b-2 border-stone-800 pb-4 gap-4">
          <div className="flex items-center gap-4">
            <h1 className="text-2xl font-semibold tracking-wide text-stone-800">我的報名</h1>
            <Link
        ...
        {registration.paymentStatus === 'pending' && (
          <div className="bg-stone-50 p-6 border border-stone-200 flex items-start gap-4">
            ...
            <div>
              <h4 className="font-semibold tracking-wide text-stone-800 mb-2">正在等待管理員對帳</h4>
        ...
        {registration.paymentStatus === 'failed' && (
          <div className="bg-red-50 p-6 border border-red-200 flex items-start gap-4">
            ...
            <div>
              <h4 className="font-semibold tracking-wide text-red-800 mb-2">繳費對帳異常</h4>
        ...
        <div className="border border-stone-200 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
            <div className="flex flex-col gap-1">
              <p className="text-stone-500 text-xs font-semibold tracking-wide uppercase tracking-widest">大會名稱</p>
              <p className="font-medium text-stone-800 text-base lg:text-lg border-b border-stone-100 pb-2">
                第44屆測量及空間資訊研討會
              </p>
            </div>
            <div className="flex flex-col gap-1">
              <p className="text-stone-500 text-xs font-semibold tracking-wide uppercase tracking-widest">報名時間</p>
              <p className="font-medium text-stone-800 text-base lg:text-lg border-b border-stone-100 pb-2">
            ...
            <div className="flex flex-col gap-1">
              <p className="text-stone-500 text-xs font-semibold tracking-wide uppercase tracking-widest">報名票種</p>
              <p className="font-medium text-stone-800 text-base lg:text-lg border-b border-stone-100 pb-2">
            ...
            <div className="flex flex-col gap-1">
              <p className="text-stone-500 text-xs font-semibold tracking-wide uppercase tracking-widest">應繳金額</p>
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      <div className="text-center mb-12 border-b border-stone-200 pb-12">
        <h1 className="text-3xl font-semibold tracking-wide text-stone-800 mb-4">您尚未報名本屆研討會</h1>
      ...
      <div className="bg-stone-50 p-8 border-t-2 border-stone-400 text-center shadow-sm mb-6">
        ...
        <h3 className="text-stone-800 font-semibold tracking-wide mb-3 text-lg tracking-wide">匯款注意事項</h3>
      ...
      <div className="bg-[#f3f3f9] p-8 border-t-2 border-[#4d4c9d] text-center shadow-sm">
        ...
        <h3 className="text-[#3a3977] font-semibold tracking-wide mb-3 text-lg tracking-wide">論文審查與投稿需知</h3>
        <p className="text-sm text-stone-600 leading-relaxed max-w-xl mx-auto">
          「我的投稿」功能需在<span className="font-semibold tracking-wide text-[#4d4c9d]">完成報名手續</span>
