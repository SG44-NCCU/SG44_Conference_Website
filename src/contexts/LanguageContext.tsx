...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'dashboard.rev.detail.opt.pending': '尚未決定',
    'dashboard.rev.detail.opt.accept': '通過　(Accept)',
    'dashboard.rev.detail.opt.revision': '修改後通過　(Minor Revision)',
    'dashboard.rev.detail.opt.reject': '未通過　(Reject)',
    'dashboard.rev.detail.form.commentLabel': '審稿評語 (Review Comments)',
    'dashboard.rev.detail.form.commentPlh': '請填寫給投稿人的評語。若選擇「修改後通過」，請說明需要修改的部分；若選擇「未通過」，請說明原因。大會發布審查結果後，評語將顯示給投稿人。',
    'dashboard.rev.detail.btn.saving': '儲存中...',
    'dashboard.rev.detail.btn.save': '儲存審稿意見',
    'dashboard.rev.detail.msg.success': '審稿意見已儲存',
    'dashboard.rev.detail.msg.fail': '儲存失敗，請重試',
  ...
  en: {
    ...
    'dashboard.rev.detail.opt.pending': 'Pending Decision',
    'dashboard.rev.detail.opt.accept': 'Accept',
    'dashboard.rev.detail.opt.revision': 'Minor Revision',
    'dashboard.rev.detail.opt.reject': 'Reject',
    'dashboard.rev.detail.form.commentLabel': 'Review Comments',
    'dashboard.rev.detail.form.commentPlh': 'Please provide comments for the author. If selecting "Minor Revision", please explain what needs modifying; if "Reject", please explain the reason. Once results are published, comments will be visible to the author.',
    'dashboard.rev.detail.btn.saving': 'Saving...',
    'dashboard.rev.detail.btn.save': 'Save Review Comments',
    'dashboard.rev.detail.msg.success': 'Review comments saved',
    'dashboard.rev.detail.msg.fail': 'Save failed, please try again',
