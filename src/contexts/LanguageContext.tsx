...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'nav.agenda.sessions': '分組論文發表',
    'nav.agenda.poster': '海報發表',
    'nav.sponsors': '參展贊助',
    ...
    'login.error.default': '登入失敗，請稍後再試。',
    'login.error.credentials': '信箱或密碼錯誤，請重新確認。',
    'login.error.unverified': '帳號尚未啟用，請先至信箱收信並完成驗證。',
    // Register page
    ...
    'register.error.exists': '此電子信箱已被註冊，請直接登入或重設密碼。',
    'register.error.validation': '部分資料格式不符，請檢查輸入內容是否完整。',
    // Recover Password
    'recover.title': '忘記密碼',
    'recover.desc': '請輸入您的註冊 Email，系統將寄送重設密碼連結。',
    'recover.submit': '發送',
    'recover.submitting': '寄送中...',
    'recover.success.title': '信件已發送',
    'recover.success.msg': '若此 Email 存在於系統中，您將收到密碼重設連結，請查收信件。',
    'recover.error.notFound': '找不到此帳號，請確認您的 Email 是否正確。',
    'recover.backToLogin': '返回登入',
    'recover.remember': '想起密碼了？返回登入',
    // Reset Password
    'reset.title': '重設密碼',
    'reset.password': '新密碼',
    'reset.password.plh': '請輸入新密碼',
    'reset.confirmPassword': '確認新密碼',
    'reset.confirmPassword.plh': '請再輸入一次新密碼',
    'reset.submit': '確認重設',
    'reset.submitting': '重設中...',
    'reset.success.title': '密碼重設成功！',
    'reset.success.msg': '您的密碼已成功更新，即將跳轉至登入頁面...',
    'reset.error.token': '連結無效或已過期，請重新申請密碼重設信件。',
    'reset.error.noToken': '錯誤：請透過信件中的連結進入此頁面。',
    // General Validation
    ...
    'dashboard.reg.detail.confValue': '第 44 屆測量及空間資訊研討會',
    ...
    'dashboard.sub.item.session': '發表場次 / 海報編號',
    ...
    // --- Award Review ---
    'dashboard.sidebar.awardReview': '學生論文獎評審',
    'dashboard.award.title': '學生論文獎評審',
    'dashboard.award.count': '篇指派',
    'dashboard.award.pts': '分',
    'dashboard.award.badge.scored': '已評分',
    'dashboard.award.empty': '目前沒有指派給您的待評審論文。',
    'dashboard.award.closed.title': '評審功能暫未開放',
    'dashboard.award.closed.desc': '目前大會尚未開放評分，您可以先瀏覽全文，等開放後再行評分。',
    'dashboard.award.detail.form.title': '論文評分表',
    'dashboard.award.detail.form.locked': '評審功能已關閉，無法修改評分',
    'dashboard.award.detail.form.score': '評分（1–10 分）',
    'dashboard.award.detail.form.scoreRequired': '請選擇分數後再儲存',
  ...
  en: {
    ...
    'recover.desc': 'Enter your registered Email to receive a reset link.',
    'recover.submit': 'Send',
    'recover.submitting': 'Sending...',
    'recover.success.title': 'Email Sent',
    'recover.success.msg': 'If this Email exists in our system, you will receive a reset link.',
    'recover.error.notFound': 'Account not found. Please check your Email.',
    'recover.backToLogin': 'Back to Login',
    'recover.remember': 'Remembered your password? Back to Login',
    // Reset Password
    'reset.title': 'Reset Password',
    'reset.password': 'New Password',
    'reset.password.plh': 'Enter new password',
    'reset.confirmPassword': 'Confirm New Password',
    'reset.confirmPassword.plh': 'Please enter again',
    'reset.submit': 'Confirm Reset',
    'reset.submitting': 'Resetting...',
    'reset.success.title': 'Password Reset Successful!',
    'reset.success.msg': 'You can now login with your new password. Redirecting to login page...',
    'reset.error.token': 'Invalid token or the link has expired. Please request a new link.',
    'reset.error.noToken': 'Error: This page must be accessed via the link in your email.',
    // General Validation
    ...
    'dashboard.sidebar.awardReview': 'Student Award Review',
    ...
    'dashboard.sub.item.session': 'Session / Poster No.',
    ...
    // --- Award Review (EN) ---
    'dashboard.award.title': 'Student Paper Award Review',
    'dashboard.award.count': 'assigned',
