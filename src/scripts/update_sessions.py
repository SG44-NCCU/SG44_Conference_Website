  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-4 md:px-6">
      ...
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold tracking-widest text-[#4d4c9d] mb-3">分組論文發表</h1>
        <p className="text-stone-500 tracking-wider">Parallel Sessions & Abstracts</p>
      </div>
...
f_sessions = 'd:/SG44_Conference_Website/src/app/(frontend)/sessions/SessionsClient.tsx'
with open(f_sessions, 'w', encoding='utf-8') as f:
    f.write(code_sessions)

print("SessionsClient updated with NSTC sessions!")
